...
\begin{column}{0.52\textwidth}
  \textbf{NeoBERT} đưa các cải tiến của thế hệ LLM
...
\begin{column}{0.49\textwidth}
  ...
  \begin{enumerate}\itemsep2pt
    ...
    \item NeoBERT gốc được huấn luyện trên \textbf{2,1 nghìn tỷ token};
          huấn luyện lại từ đầu ở quy mô tương đương vượt quá nguồn lực
          của nhóm.
