...
\begin{frame}[plain]
  ...
  \vspace{0.9em}
  \begin{columns}[t]
    \begin{column}{0.46\textwidth}\centering\footnotesize
...
\input{sections/01-gioithieu}
\input{sections/02-coso}
\input{sections/03-phuongphap}
\input{sections/04-thucnghiem}
\input{sections/05-ketluan}
\input{sections/06-tailieu}
